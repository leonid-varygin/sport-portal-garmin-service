...
from app.routes import auth, activities, garmin_health_data, daily_steps
...
app.include_router(garmin_health_data.router, prefix="/daily-steps", tags=["daily steps and health"])
